...
import { setVerseInfo } from '../../lib/config/verse'
import { DECREASE_VOLUME, EXIT, INCREASE_VOLUME, NEXT, NUM_CHAPTERS, NUM_JUZS, PAUSE, PLAY, PLAYER_BUFFER_SIZE, PLAYER_TYPE_CHAPTER, PLAYER_TYPE_JUZ, PREVIOUS, START, STOP } from '../../lib/constants'
...
export class QuranPlayer {
  ...
  #playVerse () {
    ...
    if (this.#player && this.#player.isStarted()) return
